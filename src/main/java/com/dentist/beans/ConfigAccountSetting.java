...
@Entity
@Table(name = "config_account_settings")
public class ConfigAccountSetting implements Serializable, Persistable<UUID>, ComparableSyncItem {
	...
	// Default constructor
	public ConfigAccountSetting() {
	}

	// Constructor with key and value
	public ConfigAccountSetting(String settingKey, String settingValue, int accountId) {
